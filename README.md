## SPIKES - Spectrum Plotter and Interface Kit for EMI Scanning
...
Measurement data should always be updated using git push to this repository (see Git_Push_Guide in the Documentation).
